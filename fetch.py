#!/usr/bin/env python3
"""
Recuperation des codes promo Expedia depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/expedia.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/expedia.fr"
STORE_NAME = "Expedia"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Expedia depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-expedia)"
    }
    try:
